...
const About = () => {
  return (
    <section id="about" className="about-section py-16 md:py-20 px-4 md:px-[10%]">

      <AnimatedSection> <h2 className="text-3xl md:text-4xl font-bold mb-8 md:mb-12 text-center">About Me </h2>
      </AnimatedSection>

      <AnimatedSection>
        <p className="mb-4 text-sm md:text-base">
          I'm a dedicated full-stack developer specializing in transforming
          complex ideas into intuitive, user-friendly applications. With expertise
          in web and mobile development, I prioritize user experience and
          performance. Beyond coding, I am passionate about teaching programming
          and empowering others through knowledge sharing.
        </p>
      </AnimatedSection>
      ...
      <AnimatedSection>
        <p className="mb-4 text-sm md:text-base">
          ...
          tech firm offering custom software solutions and technical consultation
          for both small businesses and large enterprises. My goal is to bridge
          the gap between technology and business needs through strategic
